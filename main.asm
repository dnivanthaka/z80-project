...
Main:
    ...
    movlw upper eeprom_data
    movwf TBLPTRU
    movlw high eeprom_data
    movwf TBLPTRH
    movlw low eeprom_data
    movwf TBLPTRL
...
write_sram_from_rom:
    ...
    ;TBLRD*+
    ;movf TABLAT, w
    ;call sram_write ;call to write sram, odd
    ;incf addressbus_val, f
    incf rom_counter, f
    movlw .16
    xorwf rom_counter, w
...
;-------------------------------------------------------
    ;org 0x6000
    eeprom_data 
		db 0xf3, 0x3e, 0x02, 0xd3, 0x00, 0x00, 0x00, 0x00
		db 0x00, 0x00, 0x00, 0x00, 0x00, 0xc3, 0x01, 0x00
